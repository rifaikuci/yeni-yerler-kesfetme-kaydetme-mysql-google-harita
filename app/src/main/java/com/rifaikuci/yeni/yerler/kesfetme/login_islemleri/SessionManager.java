...
public class SessionManager {
    ...
    public void createSession(String name, String resim, String id) {

        editor.putBoolean(LOGIN, true);
        editor.putString(NAME, name);
        editor.putString(RESIM, resim);
    ...
    public HashMap<String, String> getUserDetail() {
        ...
        user.put(RESIM, sharedPreferences.getString(RESIM, null));
